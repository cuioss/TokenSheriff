...
cd "$PROJECT_ROOT"
$MAVEN_CMD clean install -pl token-sheriff-quarkus-parent/token-sheriff-quarkus-integration-tests -q
...
$MAVEN_CMD clean package -pl token-sheriff-quarkus-parent/token-sheriff-quarkus-integration-tests -Pintegration-tests -q
