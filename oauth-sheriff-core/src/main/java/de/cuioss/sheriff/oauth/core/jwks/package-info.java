 ...
 * Key components:
 * <ul>
 *   <li>{@link de.cuioss.sheriff.oauth.core.jwks.JwksLoader} - Interface for loading JSON Web Keys from a JWKS source</li>
 *   <li>{@link de.cuioss.sheriff.oauth.core.jwks.http.HttpJwksLoader} - Implementation that loads JWKS from an HTTP endpoint</li>
 *   <li>{@link de.cuioss.sheriff.oauth.core.jwks.JwksLoaderFactory} - Factory for creating JwksLoader instances</li>
 * </ul>
 * <p>
 * The {@link de.cuioss.sheriff.oauth.core.jwks.key} subpackage contains classes for handling individual
 * keys within a JWKS.
 * <p>
 ...
 * <a href="https://github.com/cuioss/OAuthSheriff/tree/main/doc/architecture.adoc#_jwksloader">Technical Components Specification - JwksLoader</a>
 * 
