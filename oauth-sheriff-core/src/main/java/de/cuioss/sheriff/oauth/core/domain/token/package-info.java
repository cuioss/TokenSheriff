 ...
 * <ul>
 *   <li>{@link de.cuioss.sheriff.oauth.core.domain.token.TokenContent} - Base interface for JWT Token content</li>
 *   <li>{@link de.cuioss.sheriff.oauth.core.domain.token.MinimalTokenContent} - Minimal interface for token content with raw token string and type</li>
