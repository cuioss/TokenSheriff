 ...
 * They are used by the {@link de.cuioss.sheriff.oauth.core.domain.claim.ClaimName} enum
 * to convert JSON claim values to strongly-typed {@link de.cuioss.sheriff.oauth.core.domain.claim.ClaimValue} objects.
 * <p>
 * Key components:
 * <ul>
 *   <li>{@link de.cuioss.sheriff.oauth.core.domain.claim.mapper.ClaimMapper} - Base interface for claim mappers</li>
 *   <li>{@link de.cuioss.sheriff.oauth.core.domain.claim.mapper.IdentityMapper} - Maps string values directly</li>
 *   <li>{@link de.cuioss.sheriff.oauth.core.domain.claim.mapper.JsonCollectionMapper} - Maps JSON arrays to collections</li>
 *   <li>{@link de.cuioss.sheriff.oauth.core.domain.claim.mapper.OffsetDateTimeMapper} - Maps numeric timestamps to OffsetDateTime</li>
 *   <li>{@link de.cuioss.sheriff.oauth.core.domain.claim.mapper.ScopeMapper} - Special mapper for the 'scope' claim</li>
 * </ul>
 * <p>
