...
public class ParserConfig {
    public static class ParserConfigBuilder {
        ...
        public ParserConfigBuilder maxBufferSize(int bytes);     // Default: 131072 (128KB)
    }
}
----
...
|`maxBufferSize`
|Reserved buffer size limit (not currently passed to DSL-JSON; stored for DevUI display)
|128KB
|Not enforced during parsing
|===
