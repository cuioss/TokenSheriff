    ...
    class ConfigurationTests {
        ...
        void shouldValidateNegativeGracePeriodIsNotAllowed() {
            assertThrows(IllegalArgumentException.class, () ->
                    HttpJwksLoaderConfig.builder().allowLoopbackEgress(true)
                            .jwksUrl("https://example.com/jwks")
                            .issuerIdentifier("test-issuer")
        ...
        void shouldValidateMaxRetiredKeySetsIsPositive() {
            var baseBuilder = HttpJwksLoaderConfig.builder().allowLoopbackEgress(true)
                    .jwksUrl("https://example.com/jwks")
                    .issuerIdentifier("test-issuer");
            ...
            var anotherBuilder = HttpJwksLoaderConfig.builder().allowLoopbackEgress(true)
                    .jwksUrl("https://example.com/jwks")
                    .issuerIdentifier("test-issuer");
