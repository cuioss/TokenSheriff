...
* **prometheus.yml**: `token-sheriff-quarkus-parent/token-sheriff-quarkus-integration-tests/prometheus.yml`
* **docker-compose.yml**: `token-sheriff-quarkus-parent/token-sheriff-quarkus-integration-tests/docker-compose.yml`

Key settings:

* Scrape interval: 2 seconds
* Target: `token-sheriff-integration-tests:8443/q/metrics` (internal service name)
...
Location: `benchmarking/benchmarking-common/src/main/java/de/cuioss/benchmarking/common/metrics/`

=== Integration

* **WrkResultPostProcessor**: WRK benchmark integration (in `benchmark-integration-wrk` module)
* **OutputDirectoryStructure**: Directory structure management (in `benchmarking-common/output/` package)
...
* link:../benchmarking-common/README.adoc[Benchmarking Common Module]
