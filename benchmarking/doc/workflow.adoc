...
Each benchmark module generates a consistent artifact structure. See link:../README.adoc#_generated_structure[Generated Structure] in the benchmarking README for the full directory tree.

=== Badge Types

* **Performance Score** - Weighted composite score (uncapped; higher is better)
...
See xref:../../doc/validation/requirements.adoc#VALIDATION-9[Performance Requirements] for specific targets and thresholds.
...
- Generated reports exist in `benchmark-core/target/benchmark-results/gh-pages-ready/` (or `benchmark-integration-wrk/target/benchmark-results/gh-pages-ready/` for WRK)