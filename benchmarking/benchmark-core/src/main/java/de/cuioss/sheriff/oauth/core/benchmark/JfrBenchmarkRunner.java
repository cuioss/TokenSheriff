 ...
 *
 * @see de.cuioss.sheriff.oauth.core.benchmark.jfr.benchmarks.CoreJfrBenchmark
 * @see de.cuioss.sheriff.oauth.core.benchmark.jfr.benchmarks.ErrorJfrBenchmark
 * @see de.cuioss.sheriff.oauth.core.benchmark.jfr.benchmarks.MixedJfrBenchmark
 */
