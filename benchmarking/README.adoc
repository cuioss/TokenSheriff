...
* **Common Infrastructure** - Shared utilities in benchmarking-common for consistency
...
│       ├── benchmarks.json     # List of all benchmarks
│       └── status.json         # Current quality gate status
├── history/                    # Historical archive data (NOT deployed)
├── prometheus/                 # Raw Prometheus metrics (NOT deployed)
└── wrk/                        # WRK raw results (NOT deployed)
----
...
4. Deploys to `cuioss.github.io/TokenSheriff/benchmarks`
...
* xref:../doc/validation/requirements.adoc#VALIDATION-9[Performance Requirements] - Specific performance targets and verification criteria
...
* https://cuioss.github.io/TokenSheriff/benchmarks/
