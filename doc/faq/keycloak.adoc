...
*Warning:* `JWTValidation-109: Token is missing required claim: sub`
...
*Warning:* This relaxes RFC 7519 compliance. The library will log a warning (`JWTValidation-134`) when this setting is enabled.
