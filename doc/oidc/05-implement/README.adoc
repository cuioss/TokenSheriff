...
[cols="1,3"]
|===
| Status     | Ready after xref:../03-rp-spec/README.adoc[Plan 03] (spec) + xref:../04-rp-module/README.adoc[Plan 04] (skeleton)
...
| 1 | *Client config + discovery* — config (issuer, client id, auth method, scopes), resolve endpoints via core discovery; TLS + SSRF guard
