...
OAuthSheriff configuration: `sheriff.oauth.issuers.<name>.clock-skew-seconds` (default: `0`)
...
OAuthSheriff configuration: `sheriff.oauth.issuers.<name>.max-token-age-seconds` (default: disabled)
