...
_See specifications: xref:architecture.adoc[Architecture] and xref:security-reference.adoc[Security Reference]_
...
image::../resources/diagrams/jwt-token-structure.svg[JWT token structure — header, payload and signature, three Base64Url segments joined by dots, align=center]
...
_See specifications: xref:architecture.adoc#token-validation-pipeline[Token Validation Pipeline] and xref:security-reference.adoc#signature-validation[Signature Validation]_
...
_See specifications: xref:architecture.adoc#jwks-integration[Key Management] and xref:security-reference.adoc#security-controls[Security Reference]_
...
_See specifications: xref:architecture.adoc#securityeventcounter[SecurityEventCounter] and xref:security-reference.adoc#security-events-monitoring[Security Events]_
...
_See specifications: xref:security-reference.adoc[Security Reference] and xref:threat-model.adoc[Threat Model]_
...
_See specification: xref:security-reference.adoc#safe-parsing[Safe Parsing]_
...
_See specification: xref:security-reference.adoc#secure-communication[Secure Communication]_
...
_See specification: xref:security-reference.adoc#claims-validation[Claims Validation]_
...
_See specification: xref:security-reference.adoc#cryptographic-agility[Cryptographic Agility]_
...
_See specification: xref:security-reference.adoc[Security Reference]_
...
_See specifications: xref:security-reference.adoc[Security Reference]_
