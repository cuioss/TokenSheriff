...
sheriff.token.issuers.keycloak.claim-sub-optional=true
----
...
*Warning:* This relaxes RFC 7519 compliance. The library will log a warning (`TokenSheriff-131`) when this setting is enabled.
