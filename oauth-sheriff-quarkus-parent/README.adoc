...
* xref:oauth-sheriff-quarkus-integration-tests/README.adoc[oauth-sheriff-quarkus-integration-tests] - Integration test suite
...
./mvnw clean verify -Pjfr -pl oauth-sheriff-quarkus-parent/oauth-sheriff-quarkus-integration-tests -am

# Run unit tests only
./mvnw test -pl oauth-sheriff-quarkus-parent/oauth-sheriff-quarkus
----
...
xref:oauth-sheriff-quarkus/src/main/resources/META-INF/quarkus-config-doc.adoc[Quarkus Configuration Documentation]
...
* xref:oauth-sheriff-quarkus-deployment/README.adoc[oauth-sheriff-quarkus-deployment] - Contains the Quarkus deployment code for the extension
* xref:oauth-sheriff-quarkus/README.adoc[oauth-sheriff-quarkus] - Contains the runtime code for the extension
* xref:oauth-sheriff-quarkus-integration-tests/README.adoc[oauth-sheriff-quarkus-integration-tests] - Provides integration tests
