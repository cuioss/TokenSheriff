...
import de.cuioss.sheriff.oauth.integration.TestProviders;
 ...
 * {@link de.cuioss.sheriff.oauth.integration.TestProviders#allProviders()}.
 * <p>
...
class TokenValidationSpecIT extends BaseIntegrationTest {
    ...
    @ParameterizedTest(name = "[{0}]")
    @MethodSource("de.cuioss.sheriff.oauth.integration.TestProviders#allProviders")
    @Order(2)
